...
This program has the computer 'learn' the game. It runs through a number of cycles of the game, determining when the 'higher'
choice would have won that hand. Then, the computer plays the game using this data to win approximately 77% of the time.
